  ...
  <div class="min-h-screen my-10">
    ...
    <div class="text-center mb-16 pt-12">
      ...
      <p class="text-theme-muted text-lg max-w-2xl mx-auto">
        Une idée, un projet ou simplement envie d'échanger ? Je serais ravi de
        discuter avec vous !
      </p>
    </div>
    ...
    <main class="max-w-6xl mx-auto px-6">
      ...
      <section class="mb-16">
        <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
          <div
            class="card-theme p-6 text-center hover:scale-105 transition-transform duration-300"
          >
            <div
          ...
          >
            <div
              class="w-12 h-12 bg-orange-500/20 rounded-lg flex items-center justify-center mx-auto mb-3"
            >
          ...
          <form @submit.prevent="submitForm" class="space-y-6">
            ...
            <div class="grid md:grid-cols-2 gap-4">
              <div>
                <label
                  for="name"
                  class="block text-sm font-medium text-theme-primary mb-2"
                >
                  Nom complet *
                </label>
                <input
            ...
            <div>
              ...
              <p v-if="errors.projectType" class="text-red-400 text-xs mt-1">
                {{ errors.projectType }}
              </p>
            </div>
            ...
            <div class="flex items-center space-x-3">
              ...
              <label for="newsletter" class="text-sm text-theme-secondary">
                J'aimerais recevoir des nouvelles de vos projets et articles
                techniques
              </label>
            </div>
        ...
        <section class="space-y-8">
            ...
            <div class="grid grid-cols-2 gap-4">
              ...
              >
                <Icon
                  ...
                  class="w-6 h-6 text-pink-400 group-hover:scale-110 transition-transform"
                />
                <span
                  class="text-theme-secondary group-hover:text-theme-primary transition-colors"
                  >Instagram</span
          ...
          <div class="card-theme p-8">
            ...
            <div class="space-y-4">
              <details class="group">
                <summary
                  class="flex items-center justify-between cursor-pointer text-theme-primary font-medium p-2 rounded hover:bg-theme-secondary transition-colors"
                >
                ...
                <p class="text-theme-secondary text-sm mt-2 pl-2">
                  Cela dépend de la complexité, mais comptez 2-4 semaines pour
                  un site vitrine, 1-3 mois pour une application web complète.
                </p>
              </details>
              ...
              <details class="group">
                ...
                <p class="text-theme-secondary text-sm mt-2 pl-2">
                  Oui, je travaille principalement en remote avec mes clients
              ...
              <details class="group">
                ...
                <p class="text-theme-secondary text-sm mt-2 pl-2">
                  Vue.js, Nuxt.js, Node.js, TypeScript, Tailwind CSS et bien
      ...
      <section class="text-center mt-16 card-theme p-12">
        ...
        <p class="text-theme-secondary text-lg mb-8 max-w-2xl mx-auto">
          N'hésitez pas à me contacter pour discuter de vos idées. Je vous
          accompagne de la conception à la mise en ligne.
        </p>
    ...
    <Teleport to="body">
      ...
      >
        ...
        >
          <div
            class="bg-theme-secondary rounded-2xl p-8 max-w-md w-full text-center"
            @click.stop
          >
            <div
              class="w-16 h-16 bg-red-500/20 rounded-full flex items-center justify-center mx-auto mb-4"
            >
              <Icon name="ph:x-circle" class="w-8 h-8 text-red-400" />
            </div>
  ...
  meta: [
    {
      name: "description",
      content:
        "Contactez-moi pour vos projets web, applications et développements sur mesure. Réponse garantie sous 24h.",
    },
    { property: "og:title", content: "Contact - Portfolio" },
    {
      property: "og:description",
      content: "Discutons de votre projet web ensemble !",
    },
  ],
});
