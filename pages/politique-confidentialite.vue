  ...
  <div class="bg-theme-primary">
    ...
    <section class="gradient-hero py-20">
      <div class="max-w-4xl mx-auto px-6 text-center">
        <div class="inline-flex items-center justify-center w-16 h-16 bg-white/10 rounded-2xl mb-6 animate-pulse">
    ...
    <main class="max-w-4xl mx-auto px-6 py-16">
      <div class="card-theme p-8 md:p-12 space-y-12">
        ...
        <section>
          <div class="bg-green-500/10 border border-green-500/20 rounded-xl p-6 mb-8">
            <div class="flex items-start space-x-3">
              <Icon name="ph:check-circle" class="w-6 h-6 text-green-400 mt-1 flex-shrink-0" />
              <div>
                <h3 class="font-semibold text-green-400 mb-2">Engagement de confidentialité</h3>
                <p class="text-theme-secondary">
                  Ce site est conçu pour respecter votre vie privée. <strong>Aucune donnée personnelle 
                  n'est collectée</strong> sans votre consentement explicite.
                </p>
              </div>
            </div>
          </div>
        ...
        <section>
          ...
          <div class="space-y-6">
            ...
            <div class="bg-theme-secondary rounded-xl p-6">
              <h3 class="font-semibold text-theme-primary mb-3 flex items-center">
                <Icon name="ph:user-x" class="w-5 h-5 mr-2" />
                Aucune donnée personnelle
              </h3>
              <p class="text-theme-secondary mb-4">
                Ce portfolio ne collecte aucune information personnelle identifiable :
              </p>
              <ul class="space-y-2 text-theme-secondary">
                <li class="flex items-center"><Icon name="ph:x" class="w-4 h-4 mr-2 text-red-400" /> Pas de nom, prénom, email</li>
                <li class="flex items-center"><Icon name="ph:x" class="w-4 h-4 mr-2 text-red-400" /> Pas d'adresse ou téléphone</li>
                <li class="flex items-center"><Icon name="ph:x" class="w-4 h-4 mr-2 text-red-400" /> Pas de profil utilisateur</li>
                <li class="flex items-center"><Icon name="ph:x" class="w-4 h-4 mr-2 text-red-400" /> Pas de compte ou inscription</li>
              </ul>
            </div>
            ...
            <div class="bg-theme-secondary rounded-xl p-6">
              ...
              <div class="grid md:grid-cols-2 gap-4">
                <div>
                  <h4 class="font-medium text-theme-primary mb-2">Navigation</h4>
            ...
            <div class="bg-theme-secondary rounded-xl p-6">
              ...
              <p class="text-theme-secondary mb-4">
                Seules vos préférences sont sauvegardées localement dans votre navigateur :
              </p>
              <div class="bg-theme-tertiary rounded-lg p-4">
                <h4 class="font-medium text-theme-primary mb-2">Données stockées :</h4>
                <ul class="space-y-1 text-sm text-theme-secondary">
                  <li>• <span class="font-mono bg-theme-primary/20 px-1 rounded">theme_preference</span> : Votre thème choisi (ocean, cyberpunk, etc.)</li>
                  <li>• <span class="font-mono bg-theme-primary/20 px-1 rounded">visited_pages</span> : Pages déjà visitées (pour l'UX)</li>
                </ul>
          ...
          <div class="bg-theme-secondary rounded-xl p-6">
            ...
            <div class="grid md:grid-cols-3 gap-6">
              <div class="text-center">
                ...
                <h3 class="font-medium text-theme-primary mb-2">Expérience utilisateur</h3>
                <p class="text-sm text-theme-secondary">Améliorer la navigation et l'ergonomie</p>
              </div>
              <div class="text-center">
                ...
                <p class="text-sm text-theme-secondary">Optimiser les temps de chargement</p>
              </div>
              <div class="text-center">
                ...
                <h3 class="font-medium text-theme-primary mb-2">Statistiques</h3>
                <p class="text-sm text-theme-secondary">Générer des stats anonymes</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div class="space-y-6">
            ...
            <div class="bg-green-500/10 border border-green-500/20 rounded-xl p-6">
              ...
              <div class="grid md:grid-cols-2 gap-6">
                <div>
                  <h4 class="font-medium text-theme-primary mb-2">Ce que nous NE faisons PAS :</h4>
                  <ul class="space-y-1 text-sm text-theme-secondary">
                ...
                <div>
                  <h4 class="font-medium text-theme-primary mb-2">Ce que nous utilisons :</h4>
                  <ul class="space-y-1 text-sm text-theme-secondary">
            ...
            <!-- Gestion du stockage -->
            <div class="bg-theme-secondary rounded-xl p-6">
              <h3 class="font-semibold text-theme-primary mb-3">Gestion de vos données locales</h3>
              <p class="text-theme-secondary mb-4">
          ...
          <div class="bg-theme-secondary rounded-xl p-6">
            ...
            <div class="grid md:grid-cols-2 gap-6">
              <div class="space-y-4">
                <div class="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 class="font-medium text-theme-primary">Droit d'accès</h3>
                    <p class="text-sm text-theme-secondary">Connaître les données vous concernant</p>
                  </div>
                </div>
                <div class="flex items-start space-x-3">
                  <Icon name="ph:pencil" class="w-5 h-5 text-green-400 mt-1" />
                  <div>
                    <h3 class="font-medium text-theme-primary">Droit de rectification</h3>
                    <p class="text-sm text-theme-secondary">Corriger des données inexactes</p>
                  </div>
                </div>
                <div class="flex items-start space-x-3">
                  <Icon name="ph:trash" class="w-5 h-5 text-red-400 mt-1" />
                  <div>
                    <h3 class="font-medium text-theme-primary">Droit à l'effacement</h3>
                    <p class="text-sm text-theme-secondary">Supprimer vos données</p>
                  </div>
                </div>
              </div>
              <div class="space-y-4">
                <div class="flex items-start space-x-3">
                  ...
                  <div>
                    <h3 class="font-medium text-theme-primary">Droit à la portabilité</h3>
                    <p class="text-sm text-theme-secondary">Récupérer vos données</p>
                  </div>
                </div>
                <div class="flex items-start space-x-3">
                  <Icon name="ph:hand-palm" class="w-5 h-5 text-orange-400 mt-1" />
                  <div>
                    <h3 class="font-medium text-theme-primary">Droit d'opposition</h3>
                    <p class="text-sm text-theme-secondary">Vous opposer au traitement</p>
                  </div>
                </div>
                <div class="flex items-start space-x-3">
                  <Icon name="ph:pause" class="w-5 h-5 text-yellow-400 mt-1" />
                  <div>
                    <h3 class="font-medium text-theme-primary">Droit de limitation</h3>
                    <p class="text-sm text-theme-secondary">Limiter le traitement</p>
                  </div>
                </div>
              </div>
            </div>
            <div class="mt-6 p-4 bg-theme-tertiary rounded-lg">
              <p class="text-sm text-theme-secondary">
                <strong>Note :</strong> Étant donné que ce site ne collecte aucune donnée personnelle, 
                la plupart de ces droits ne s'appliquent pas. Seules vos préférences locales peuvent être effacées.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div class="bg-theme-secondary rounded-xl p-6">
            ...
            <div class="grid md:grid-cols-2 gap-6">
              <div>
                <h3 class="font-semibold text-theme-primary mb-2">Délégué à la Protection des Données</h3>
                <p class="text-theme-secondary">
                  Email : <a href="mailto:[dpo@votre-domain.com]" class="text-theme-primary hover:underline">[dpo@votre-domain.com]</a><br>
                  Courrier : [Adresse DPO]<br>
                  Réponse sous 30 jours maximum
                </p>
              </div>
              <div>
                <h3 class="font-semibold text-theme-primary mb-2">Autorité de contrôle</h3>
                <p class="text-theme-secondary">
                  En cas de litige, vous pouvez saisir la CNIL :<br>
                  <a href="https://www.cnil.fr" target="_blank" class="text-theme-primary hover:underline">www.cnil.fr</a><br>
          ...
          <div class="bg-theme-secondary rounded-xl p-6">
            ...
            <div class="grid md:grid-cols-3 gap-4">
              <div class="text-center">
                ...
                <h3 class="font-medium text-theme-primary mb-2">Chiffrement SSL/TLS</h3>
                <p class="text-xs text-theme-secondary">Connexion sécurisée HTTPS</p>
              </div>
              <div class="text-center">
                <div class="w-12 h-12 bg-blue-500/20 rounded-lg flex items-center justify-center mx-auto mb-3">
                  <Icon name="ph:shield-check" class="w-6 h-6 text-blue-400" />
                </div>
                <h3 class="font-medium text-theme-primary mb-2">Headers de sécurité</h3>
                <p class="text-xs text-theme-secondary">CSP, HSTS, X-Frame-Options</p>
              </div>
              <div class="text-center">
                <div class="w-12 h-12 bg-purple-500/20 rounded-lg flex items-center justify-center mx-auto mb-3">
                  <Icon name="ph:code" class="w-6 h-6 text-purple-400" />
                </div>
                <h3 class="font-medium text-theme-primary mb-2">Code sécurisé</h3>
                <p class="text-xs text-theme-secondary">Protection XSS, validation</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div class="bg-theme-secondary rounded-xl p-6">
            <p class="text-theme-secondary mb-4">
              ...
              Nous vous informerons de tout changement important par :
            </p>
            <ul class="space-y-2 text-theme-secondary">
              ...
              <li class="flex items-center">
                <Icon name="ph:file-text" class="w-4 h-4 mr-2 text-purple-400" />
      ...
      <div class="text-center mt-12 space-y-4">
        <div class="inline-flex items-center space-x-4 bg-theme-secondary rounded-xl px-6 py-4">
          <div class="flex items-center space-x-2">
            ...
            <span class="text-sm font-medium text-theme-primary">{{ lastUpdate }}</span>
          </div>
        ...
        <div v-if="localDataInfo" class="bg-theme-secondary rounded-xl p-4 max-w-md mx-auto">
          <h3 class="text-sm font-medium text-theme-primary mb-2">Vos données locales actuelles :</h3>
          <div class="text-xs text-theme-secondary space-y-1">
            <div>Thème : {{ localDataInfo.theme || 'default' }}</div>
            <div>Taille totale : {{ localDataInfo.size || '0' }} octets</div>
          </div>
        </div>
      </div>
    </main>
...
useHead({
  ...
  meta: [
    { 
      name: 'description', 
      content: 'Politique de confidentialité du portfolio - Protection des données personnelles et respect de la vie privée.' 
    },
    { property: 'og:title', content: 'Politique de confidentialité - Portfolio' },
...
const clearLocalData = () => {
  if (process.client) {
    const confirmed = confirm('Êtes-vous sûr de vouloir effacer toutes vos données locales (préférences de thème, etc.) ?')
    if (confirmed) {
      localStorage.clear()
...
const showLocalData = () => {
  if (process.client) {
    ...
    if (data.length === 0) {
      ...
      const message = data.map(item => `${item.key}: ${item.value}`).join('\n')
...
.btn-theme-primary:hover, .btn-theme-secondary:hover {
